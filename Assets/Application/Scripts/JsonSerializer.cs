...
public class JSONObject : IEnumerable<KeyValuePair<string, JSONValue>>, System.IDisposable
{
	...
	private readonly IDictionary<string, JSONValue> values = new Dictionary<string, JSONValue>(StringComparer.InvariantCultureIgnoreCase);
	...
	{
		values = new Dictionary<string, JSONValue>(StringComparer.InvariantCultureIgnoreCase);
...
public class JSONSerialize
{
	...
	public static Dictionary<string,object>DeserializeToDictionary(string jsonFile, string key)
	{
